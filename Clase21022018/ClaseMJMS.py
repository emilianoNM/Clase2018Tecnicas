...
class Tareas():
    ...
    def imprimirTarea(self):
        print("El alumno",str(self.alumno),",hizo la tarea del profesor",str(self.profesor),"de la materia de ",self.tipo,",btuvo una calificacion de",self.calificacion)
